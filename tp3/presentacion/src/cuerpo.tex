...
El período de un generador: es blabla repiten..., algunos repiten blabla blabla. Vale la pena notar que un período grande no determina que un generador es bueno, debemos verificar que los números que se generan se comportan como si fueran aleatorios.
