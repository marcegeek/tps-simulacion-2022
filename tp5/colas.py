...
class ColaMMC(Simulacion):
    ...
    def medidas_estadisticas(self):
        return {
            "demora_promedio": VariableEstadistica("Demora promedio esperada en cola", self.demora_promedio, simbolo=r'$\hat{d}(n)$'),
            "tiempo_promedio_sistema": VariableEstadistica("Tiempo promedio en el sistema", self.tiempo_promedio_sistema, simbolo=r'$\hat{d}(n) + \hat{s}(n)$'),
            'n_promedio_clientes_cola': VariableEstadistica('Cantidad de clientes en cola en promedio', self.promedio_clientes_cola, simbolo=r'$\hat{q}(n)$'),
            'tiempo_promedio_servicio': VariableEstadistica('Tiempo promedio de servicio', self.tiempo_promedio_servicio, simbolo=r'$\hat{s}(n)$'),
            'n_promedio_clientes_sistema': VariableEstadistica('Promedio de clientes en el sistema', self.promedio_clientes_sistema, simbolo=r'$\hat{q}(n) + \hat{u}(n)$'),
